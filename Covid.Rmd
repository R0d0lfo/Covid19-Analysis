...
```{r}
daywise = read.csv(file = 'csv/firstdataset.csv')
head(daywise)
...
fg = plot_ly(daywise, x = ~Date)

cnf.line = list(color = cnf, width = 3)
dth.line = list(color = dth, width = 3)
rec.line = list(color = rec, width = 3)

fg = fg %>% add_trace(y = ~Confirmed, name = 'Confermati', mode = 'lines', type ='scatter', line = cnf.line)
fg = fg %>% add_trace(y = ~Recovered, name = 'Guariti', mode = 'lines', type ='scatter', line = rec.line)
fg = fg %>% add_trace(y = ~Deaths, name = 'Morti', mode = 'lines', type ='scatter', line = dth.line)
...
```{r}
fg1 = plot_ly(daywise, x = ~Date, y = ~New.Cases, type = 'bar', name = 'Nuovi Casi')
fg2 = plot_ly(daywise, x = ~Date, y = ~Deaths...100.Cases, type = 'bar', name = 'Morti / 100 Casi')
fg3 = plot_ly(daywise, x = ~Date, y = ~Recovered...100.Cases, type = 'bar', name = 'Guariti / 100 Casi')
